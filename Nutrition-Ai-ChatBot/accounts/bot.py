...
data = {'age': None, 'veg': None, 'weight': None, 'height': None}

data = pd.read_csv('/home/jaydeep/Desktop/college/Term3/capston/Nutrition-Ai-ChatBot/Nutrition-Ai-ChatBot/accounts/food.csv')
...
if __name__ == '__main__':
    ...
    Button(main_win, text='Quit', command=main_win.quit).grid(row=5, column=0, sticky=W,
                                                              pady=4)
    Button(main_win, text='Weight Loss', command=Weight_Loss).grid(row=1, column=4,
                                                                   sticky=W, pady=4)
    Button(main_win, text='Weight Gain', command=Weight_Gain).grid(row=2, column=4,
                                                                   sticky=W, pady=4)
    Button(main_win, text='Healthy', command=Healthy).grid(row=3, column=4, sticky=W,
                                                           pady=4)
